// To parse this data:
//
//   import { Convert, GIFSearchInterface } from "./file";
//
//   const gIFSearchInterface = Convert.toGIFSearchInterface(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface GIFSearchInterface {
    data:       Gif[];
...
export class Convert {
    public static toGIFSearchInterface(json: string): GIFSearchInterface {
        return cast(JSON.parse(json), r("GIFSearchInterface"));
    }

    public static gIFSearchInterfaceToJson(value: GIFSearchInterface): string {
        return JSON.stringify(uncast(value, r("GIFSearchInterface")), null, 2);
    }
}
